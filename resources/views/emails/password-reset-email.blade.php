<x-email-layout>
    ...
    ">
        ...
        <a href="{{$locale === 'ka' ? urldecode(env('FRONT_URL').'ka'.'?stage=passwordReset&feedback=').$url: urldecode(env('FRONT_URL').'?stage=passwordReset&feedback=').$url  }}" style=";
        margin-top: 2.5rem;
        font-size: 18px;
        font-weight: 400;
        color: #FFFFFF;
        ...
        color: #DDCCAA;
        font-family: 'Inter', 'sans-serif';">
            {{$locale === 'ka' ? urldecode(env('FRONT_URL').'ka'.'?stage=passwordReset&feedback=').$url: urldecode(env('FRONT_URL').'?stage=passwordReset&feedback=').$url}}
        </p>
